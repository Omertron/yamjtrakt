...
public class MainWindow extends javax.swing.JFrame {
    ...
    public MainWindow() {
        ...
        // Set the default slow update
        this.mnuSlowerUpdate.setSelected(YamjTraktApp.isSlowerUpdate());
    }
    ...
    private void initComponents() {
        ...
        mnuSlowerUpdate = new javax.swing.JCheckBoxMenuItem();
        ...
        mnuSlowerUpdate.setText("Slower Trakt update");
        mnuSlowerUpdate.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mnuSlowerUpdateActionPerformed(evt);
            }
        });
        mnuSettings.add(mnuSlowerUpdate);
    ...
    private void mnuSlowerUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuSlowerUpdateActionPerformed
        YamjTraktApp.setSlowerUpdate(mnuSlowerUpdate.isSelected());
        LOG.debug("Setting SlowerUpdate to " + YamjTraktApp.isSlowerUpdate());

        if (mnuSlowerUpdate.isSelected()) {
            int numberOfThreads = (Integer) spnProcessingThreads.getValue();
            LOG.debug("Reducing number of threads to 1 from " + numberOfThreads);
            spnProcessingThreads.setValue(1);
            spnProcessingThreads.setEnabled(Boolean.FALSE);
        } else {
            spnProcessingThreads.setEnabled(Boolean.TRUE);
        }
    }//GEN-LAST:event_mnuSlowerUpdateActionPerformed
    ...
    private javax.swing.JCheckBoxMenuItem mnuSlowerUpdate;
